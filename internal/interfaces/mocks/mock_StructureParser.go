...
func (_m *StructureParser) ParseDocumentStructure(data []byte) (*filestructure.BwwFile, error) {
	ret := _m.Called(data)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func([]byte) (*filestructure.BwwFile, error)); ok {
		return rf(data)
	}
	if rf, ok := ret.Get(0).(func([]byte) *filestructure.BwwFile); ok {
		r0 = rf(data)
	} else {
		if ret.Get(0) != nil {
...
func (_c *StructureParser_ParseDocumentStructure_Call) Return(_a0 *filestructure.BwwFile, _a1 error) *StructureParser_ParseDocumentStructure_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StructureParser_ParseDocumentStructure_Call) RunAndReturn(run func([]byte) (*filestructure.BwwFile, error)) *StructureParser_ParseDocumentStructure_Call {
	_c.Call.Return(run)
	return _c
}
