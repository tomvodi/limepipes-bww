...
func (_m *TokenStructureConverter) Convert(tokens []*common.Token) (*structure.BwwFile, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func([]*common.Token) (*structure.BwwFile, error)); ok {
		return rf(tokens)
	}
	if rf, ok := ret.Get(0).(func([]*common.Token) *structure.BwwFile); ok {
		r0 = rf(tokens)
	} else {
		if ret.Get(0) != nil {
...
func (_c *TokenStructureConverter_Convert_Call) Return(_a0 *structure.BwwFile, _a1 error) *TokenStructureConverter_Convert_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TokenStructureConverter_Convert_Call) RunAndReturn(run func([]*common.Token) (*structure.BwwFile, error)) *TokenStructureConverter_Convert_Call {
	_c.Call.Return(run)
	return _c
}
