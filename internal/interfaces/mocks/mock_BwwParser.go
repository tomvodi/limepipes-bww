...
func (_m *BwwParser) ParseBwwData(data []byte) ([]*messages.ParsedTune, error) {
	ret := _m.Called(data)
...
func (_c *BwwParser_ParseBwwData_Call) Return(_a0 []*messages.ParsedTune, _a1 error) *BwwParser_ParseBwwData_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *BwwParser_ParseBwwData_Call) RunAndReturn(run func([]byte) ([]*messages.ParsedTune, error)) *BwwParser_ParseBwwData_Call {
	_c.Call.Return(run)
	return _c
}
