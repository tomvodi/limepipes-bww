...
func (_m *BwwParser) ParseBwwData(data []byte) (musicmodel.MusicModel, error) {
	ret := _m.Called(data)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func([]byte) (musicmodel.MusicModel, error)); ok {
		return rf(data)
	}
	if rf, ok := ret.Get(0).(func([]byte) musicmodel.MusicModel); ok {
		r0 = rf(data)
	} else {
		if ret.Get(0) != nil {
...
func (_c *BwwParser_ParseBwwData_Call) Return(_a0 musicmodel.MusicModel, _a1 error) *BwwParser_ParseBwwData_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *BwwParser_ParseBwwData_Call) RunAndReturn(run func([]byte) (musicmodel.MusicModel, error)) *BwwParser_ParseBwwData_Call {
	_c.Call.Return(run)
	return _c
}
